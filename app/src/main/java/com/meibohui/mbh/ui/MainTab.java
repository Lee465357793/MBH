...
import com.meibohui.mbh.fragment.DefaultFragment;
...
public enum MainTab {
	...
	TWEET(1, R.string.main_tab_name_explore, R.drawable.tab_icon_tweet,
			DefaultFragment.class),

	QUICK(2, R.string.main_tab_name_quick, R.drawable.tab_icon_new,
			null),

	EXPLORE(3, R.string.main_tab_name_habit, R.drawable.tab_icon_explore,
			DefaultFragment.class),
